...
BeginEstim=53;
EndEstim=172;
DataMat2=DataMat1(BeginEstim:EndEstim,:);%2:end);
VarNames=XlsInfo(2,1:end);%:);
...
PriorBVARMinnesota.BlockIndex=[1 5;4 11];
warning off all
...
Sdmat(2,7)=1;   %1stLag vector; cpi
%Sdmat(2,37)=-1; %4thLag vector; cpi
Sdmat(2,40)=-1; %4thLag vector; cpi
...
for j = 1 : S
    ...
    cpiHD=cpiHD+[DecompVAR.yfs(:,:,7) DecompVAR.initeffecty(7,:)'];
...
%% xls
% xlswrite('../xls_files/HDstest.xlsx',[yHD DataMat(5:end,5)],'yHD','B58:N173');
% 
% xlswrite('../xls_files/HDstest.xlsx',[cpiHD DataMat(5:end,7)],'cpiHD','B58:N173');